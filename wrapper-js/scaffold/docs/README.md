...
- [Agent Operations](./agent-operations.md): the generated-repo-safe command loop for downstream maintainers and agents
...
Read those first. Everything else is either reference material or a decision record.
