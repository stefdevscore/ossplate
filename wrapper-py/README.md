...
This package is the installed PyPI delivery adapter for the same `ossplate` CLI described in the main docs. It forwards to the bundled native binary for your current platform and exposes the same subcommands as the Rust core.
