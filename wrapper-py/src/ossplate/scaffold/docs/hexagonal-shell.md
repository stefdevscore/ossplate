...
## HEX-00 Principle Fit

This shell follows the same repo-wide principle set described in [Architecture](./architecture.md):

- DRY through canonical contracts and generated assets
- pragmatic SOLID through a functional core and thin adapters
- one hexagonal product shell centered in Rust
