use crate::sync::{issue, ValidationIssue};
...
pub(crate) fn validate_runtime_package_json_darwin_arm64(
    config: &ToolConfig,
    content: &str,
) -> Result<Vec<ValidationIssue>> {
...
pub(crate) fn sync_runtime_package_json_darwin_arm64(
    config: &ToolConfig,
    content: &str,
) -> Result<String> {
...
pub(crate) fn validate_runtime_package_json_darwin_x64(
    config: &ToolConfig,
    content: &str,
) -> Result<Vec<ValidationIssue>> {
...
pub(crate) fn sync_runtime_package_json_darwin_x64(
    config: &ToolConfig,
    content: &str,
) -> Result<String> {
...
pub(crate) fn validate_runtime_package_json_linux_x64(
    config: &ToolConfig,
    content: &str,
) -> Result<Vec<ValidationIssue>> {
...
pub(crate) fn sync_runtime_package_json_linux_x64(
    config: &ToolConfig,
    content: &str,
) -> Result<String> {
...
pub(crate) fn validate_runtime_package_json_win32_x64(
    config: &ToolConfig,
    content: &str,
) -> Result<Vec<ValidationIssue>> {
...
pub(crate) fn sync_runtime_package_json_win32_x64(
    config: &ToolConfig,
    content: &str,
) -> Result<String> {
